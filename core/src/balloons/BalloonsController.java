...
public class BalloonsController {
    ...
    private CloudGhost[] cloudGhosts;
    ...
    public BalloonsController(){
        ...
        this.cloudGhosts = nivel1.getCloudGhosts();
    ...
    public Sprite[] gerarSprites(){
        Sprite[] sprites = new Sprite[nuvens.length + avioes.length + cloudGhosts.length + passaros.length + 1];
        int i = 0;
        for(Nuvem n: nuvens){
